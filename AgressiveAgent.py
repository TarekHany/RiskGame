...
class AgressiveAgent(Agent):
    ...
    def attack(self):
        ...
        if attackingCountry and neighborWithMaxTroops:
            ...
            if use_timer:
                ...
                t = threading.Timer(3, self.setTroops,args=(neighborWithMaxTroops, attackingCountry, num_to, num_from))
                t.start()
    ...
    def setTroops(self,country_to,country_from,num_to,num_from):
